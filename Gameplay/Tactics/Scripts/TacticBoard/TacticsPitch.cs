...
//         public TMP_Dropdown viewModesDropDown;
//         
//         // Track whether usable views are currently shown
//         private bool _areUsableViewsShown = false;
//         public bool AreUsableViewsShown => _areUsableViewsShown;
//     
//         private void Awake()
//         {
//             // Debug.Log("Starting Awake() in TacticsPitch");
...
//         public void ShowUsablePlayerItemViews()
//         {
//             // Check if already shown to avoid redundant operations
//             if (_areUsableViewsShown)
//             {
//                 Debug.Log("Usable views are already shown");
//                 return;
//             }
//             
//             // using( new NinjaTools.FlexBuilder.LayoutAlgorithms.ExperimentalDelayUpdates2() )
...
//             
//             // Update the flag
//             _areUsableViewsShown = true;
//             Debug.Log("Showing usable player item views");
//             // }
//         }
//     
//         // public static void HideUnusedPlayerItemViews(PositionZonesContainerView[] zoneContainerViews)
...
//             if (!_areUsableViewsShown)
//             {
//                 Debug.Log("Usable views are already hidden");
//                 return;
//             }
//             
//             // using (new NinjaTools.FlexBuilder.LayoutAlgorithms.ExperimentalDelayUpdates2())
...
//             
//             // Update the flag
//             _areUsableViewsShown = false;
//             Debug.Log("Hiding unused player item views");
//             // }
//         }
//         
//         // Force show/hide without checking the flag (useful for initialization or refresh)
//         public void ForceShowUsablePlayerItemViews()
//         {
//             _areUsableViewsShown = false;
//             ShowUsablePlayerItemViews();
//         }
//         
//         public void ForceHideUnusedPlayerItemViews()
//         {
//             _areUsableViewsShown = true;
//             HideUnusedPlayerItemViews();
//         }
